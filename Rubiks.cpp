...
void Rubiks::rotateSide(GLint Face)
{
	...
	{
	case W:
		Color temp[3] = {*faceColor[R][0], *faceColor[R][1], *faceColor[R][2]};
		*faceColor[R] = *faceColor[B];
		Color temp2[3] = {*faceColor[G][0], *faceColor[G][1], *faceColor[G][2]};
		*faceColor[G] = temp;
		Color temp[3] = {*faceColor[O][0], *faceColor[O][1], *faceColor[O][2]};
		*faceColor[O] = temp2;
		*faceColor[B] = temp;

		// face corners
		Color temp3 = *faceColor[W][2];
		*faceColor[W][2] = *faceColor[W][0];
		Color temp4 = *faceColor[W][8];
		*faceColor[W][8] = temp3;
		Color temp3 = *faceColor[W][6];
		*faceColor[W][6] = temp4;
		*faceColor[W][0] = temp3;
		// face edges
		Color temp3 = *faceColor[W][5];
		*faceColor[W][5] = *faceColor[W][1];
		Color temp4 = *faceColor[W][7];
		*faceColor[W][7] = temp3;
		Color temp3 = *faceColor[W][3];
		*faceColor[W][3] = temp4;
		*faceColor[W][1] = temp3;
		break;
	case Y:
		Color temp[3] = {*faceColor[O][0], *faceColor[O][1], *faceColor[O][2]};
		*faceColor[O] = *faceColor[B];
		Color temp2[3] = {*faceColor[G][0], *faceColor[G][1], *faceColor[G][2]};
		*faceColor[G] = temp;
		Color temp[3] = {*faceColor[R][0], *faceColor[R][1], *faceColor[R][2]};
		*faceColor[R] = temp2;
		*faceColor[B] = temp;
		...
		// face corners
		Color temp3 = *faceColor[Y][2];
		*faceColor[Y][2] = *faceColor[Y][0];
		Color temp4 = *faceColor[Y][8];
		*faceColor[Y][8] = temp3;
		Color temp3 = *faceColor[Y][6];
		*faceColor[Y][6] = temp4;
		*faceColor[Y][0] = temp3;
		// face edges
		Color temp3 = *faceColor[Y][5];
		*faceColor[Y][5] = *faceColor[Y][1];
		Color temp4 = *faceColor[Y][7];
		*faceColor[Y][7] = temp3;
		Color temp3 = *faceColor[Y][3];
		*faceColor[Y][3] = temp4;
		*faceColor[Y][1] = temp3;
		break;
	case O:
		Color temp[3] = {*faceColor[G][0], *faceColor[G][1], *faceColor[G][2]};
		*faceColor[G] = *faceColor[W];
		Color temp2[3] = {*faceColor[Y][0], *faceColor[Y][1], *faceColor[Y][2]};
		*faceColor[Y] = temp;
		Color temp[3] = {*faceColor[B][0], *faceColor[B][1], *faceColor[B][2]};
		*faceColor[B] = temp2;
		*faceColor[W] = temp;

		// face corners
		Color temp3 = *faceColor[O][2];
		*faceColor[O][2] = *faceColor[O][0];
		Color temp4 = *faceColor[O][8];
		*faceColor[O][8] = temp3;
		Color temp3 = *faceColor[O][6];
		*faceColor[O][6] = temp4;
		*faceColor[O][0] = temp3;
		// face edges
		Color temp3 = *faceColor[O][5];
		*faceColor[O][5] = *faceColor[O][1];
		Color temp4 = *faceColor[O][7];
		*faceColor[O][7] = temp3;
		Color temp3 = *faceColor[O][3];
		*faceColor[O][3] = temp4;
		*faceColor[O][1] = temp3;
		break;
	case R:
		Color temp[3] = {*faceColor[B][0], *faceColor[B][1], *faceColor[B][2]};
		*faceColor[B] = *faceColor[W];
		Color temp2[3] = {*faceColor[Y][0], *faceColor[Y][1], *faceColor[Y][2]};
		*faceColor[Y] = temp;
		Color temp[3] = {*faceColor[G][0], *faceColor[G][1], *faceColor[G][2]};
		*faceColor[G] = temp2;
		*faceColor[W] = temp;
		...
		// face corners
		Color temp3 = *faceColor[R][2];
		*faceColor[R][2] = *faceColor[R][0];
		Color temp4 = *faceColor[R][8];
		*faceColor[R][8] = temp3;
		Color temp3 = *faceColor[R][6];
		*faceColor[R][6] = temp4;
		*faceColor[R][0] = temp3;
		// face edges
		Color temp3 = *faceColor[R][5];
		*faceColor[R][5] = *faceColor[R][1];
		Color temp4 = *faceColor[R][7];
		*faceColor[R][7] = temp3;
		Color temp3 = *faceColor[R][3];
		*faceColor[R][3] = temp4;
		*faceColor[R][1] = temp3;
		break;
	case G:
		Color temp[3] = {*faceColor[R][0], *faceColor[R][1], *faceColor[R][2]};
		*faceColor[R] = *faceColor[W];
		Color temp2[3] = {*faceColor[Y][0], *faceColor[Y][1], *faceColor[Y][2]};
		*faceColor[Y] = temp;
		Color temp[3] = {*faceColor[O][0], *faceColor[O][1], *faceColor[O][2]};
		*faceColor[O] = temp2;
		*faceColor[W] = temp;
		...
		// face corners
		Color temp3 = *faceColor[G][2];
		*faceColor[G][2] = *faceColor[G][0];
		Color temp4 = *faceColor[G][8];
		*faceColor[G][8] = temp3;
		Color temp3 = *faceColor[G][6];
		*faceColor[G][6] = temp4;
		*faceColor[G][0] = temp3;
		// face edges
		Color temp3 = *faceColor[G][5];
		*faceColor[G][5] = *faceColor[G][1];
		Color temp4 = *faceColor[G][7];
		*faceColor[G][7] = temp3;
		Color temp3 = *faceColor[G][3];
		*faceColor[G][3] = temp4;
		*faceColor[G][1] = temp3;
		break;
	case B:
		Color temp[3] = {*faceColor[O][0], *faceColor[O][1], *faceColor[O][2]};
		*faceColor[O] = *faceColor[W];
		Color temp2[3] = {*faceColor[Y][0], *faceColor[Y][1], *faceColor[Y][2]};
		*faceColor[Y] = temp;
		Color temp[3] = {*faceColor[R][0], *faceColor[R][1], *faceColor[R][2]};
		*faceColor[R] = temp2;
		*faceColor[W] = temp;
		...
		// face corners
		Color temp3 = *faceColor[B][2];
		*faceColor[B][2] = *faceColor[B][0];
		Color temp4 = *faceColor[B][8];
		*faceColor[B][8] = temp3;
		Color temp3 = *faceColor[B][6];
		*faceColor[B][6] = temp4;
		*faceColor[B][0] = temp3;
		// face edges
		Color temp3 = *faceColor[B][5];
		*faceColor[B][5] = *faceColor[B][1];
		Color temp4 = *faceColor[B][7];
		*faceColor[B][7] = temp3;
		Color temp3 = *faceColor[B][3];
		*faceColor[B][3] = temp4;
		*faceColor[B][1] = temp3;
		break;
	}
